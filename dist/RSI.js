...
const fromPrices = (prices) => (0, function_1.pipe)(prices, (0, mapInterval_1.mapInterval)(exports.toPricePoint)(2));
...
const getRSIAcc = (period) => (prices) => (0, function_1.pipe)(prices, fromPrices, fp_ts_1.option.chain((acc) => (0, function_1.pipe)(acc.result, (0, splitAtFixed_1.splitAtFixed)(period), fp_ts_1.option.map(([init, rest]) => (0, function_1.pipe)(rest, fp_ts_1.array.reduce((0, exports.initialRSI)(init), (0, exports.nextRSI)(period)))), fp_ts_1.option.map((rsi) => ({ rsi, acc })))));
