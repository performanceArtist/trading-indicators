...
export declare const withNextArrayQueue: <A, B>(f: (init: nonEmptyArray.NonEmptyArray<A>) => B) => ({ prevQueue, result }: IntervalAcc<A, nonEmptyArray.NonEmptyArray<B>>, cur: A) => IntervalAcc<A, nonEmptyArray.NonEmptyArray<B>>;
