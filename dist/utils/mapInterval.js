...
exports.mapInterval = exports.withNextArrayQueue = exports.reduceInterval = exports.withNextQueue = void 0;
...
const withNextArrayQueue = (f) => (0, exports.withNextQueue)((acc, cur) => (0, function_1.pipe)(acc, fp_ts_1.array.append(f(cur))));
exports.withNextArrayQueue = withNextArrayQueue;
const mapInterval = (f) => (0, exports.reduceInterval)((init) => fp_ts_1.nonEmptyArray.of(f(init)), (0, exports.withNextArrayQueue)(f));
